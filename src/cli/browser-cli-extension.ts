...
export async function installChromeExtension(opts?: {
  ...
  if (!hasManifest(src)) {
    throw new Error("Bundled Chrome extension is missing. Reinstall O.R.I.O.N and try again.");
  }
      ...
      defaultRuntime.error(
        info(
          [
            ...
            `- Pin "O.R.I.O.N Browser Relay", then click it on the tab (badge shows ON)`,
            "",
